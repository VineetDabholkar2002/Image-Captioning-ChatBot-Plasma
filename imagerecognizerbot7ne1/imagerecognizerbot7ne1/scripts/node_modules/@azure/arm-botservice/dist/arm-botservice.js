...
(function (global, factory) {
    ...
    (global = global || self, factory((global.Azure = global.Azure || {}, global.Azure.ArmBotservice = {}), global.msRestAzure, global.msRest));
    ...
    ***************************************************************************** */
    ...
    var PrivateEndpointConnection = {
        ...
        type: {
            ...
            modelProperties: __assign(__assign({}, PrivateLinkResourceBase.type.modelProperties), { privateEndpoint: {
    ...
    var DirectLineSpeechChannelProperties = {
    ...
    var PrivateLinkResource = {
        ...
        type: {
            ...
            modelProperties: __assign(__assign({}, PrivateLinkResourceBase.type.modelProperties), { groupId: {
                    readOnly: true,
    ...
    var createOperationSpec = {
        ...
        requestBody: {
            ...
            mapper: __assign(__assign({}, Bot), { required: true })
        },
        responses: {
            200: {
                bodyMapper: Bot
    ...
    var getCheckNameAvailabilityOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, CheckNameAvailabilityRequestBody), { required: true })
        },
        responses: {
            200: {
    ...
    var createOperationSpec$1 = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, BotChannel), { required: true })
        },
        responses: {
            200: {
    ...
    var DirectLine = /** @class */ (function () {
         ...
         * @param {AzureBotServiceContext} client Reference to the service client.
         */
        function DirectLine(client) {
            this.client = client;
        }
        DirectLine.prototype.regenerateKeys = function (resourceGroupName, resourceName, channelName, parameters, options, callback) {
            return this.client.sendOperationRequest({
                resourceGroupName: resourceGroupName,
                resourceName: resourceName,
                channelName: channelName,
    ...
    var regenerateKeysOperationSpec = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, SiteInfo), { required: true })
        },
        responses: {
            200: {
                bodyMapper: BotChannel
    ...
    var createOperationSpec$2 = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, ConnectionSetting), { required: true })
        },
        responses: {
            200: {
                bodyMapper: ConnectionSetting
    ...
    var HostSettings = /** @class */ (function () {
        /**
         * Create a HostSettings.
         * @param {AzureBotServiceContext} client Reference to the service client.
         */
        function HostSettings(client) {
            this.client = client;
        }
        HostSettings.prototype.get = function (options, callback) {
            return this.client.sendOperationRequest({
                options: options
    ...
    var PrivateEndpointConnections = /** @class */ (function () {
        ...
        PrivateEndpointConnections.prototype.create = function (resourceGroupName, resourceName, privateEndpointConnectionName, properties, options, callback) {
            return this.client.sendOperationRequest({
                resourceGroupName: resourceGroupName,
                resourceName: resourceName,
                privateEndpointConnectionName: privateEndpointConnectionName,
        ...
        PrivateEndpointConnections.prototype.deleteMethod = function (resourceGroupName, resourceName, privateEndpointConnectionName, options, callback) {
            return this.client.sendOperationRequest({
                resourceGroupName: resourceGroupName,
                resourceName: resourceName,
                privateEndpointConnectionName: privateEndpointConnectionName,
    ...
    var PrivateLinkResources = /** @class */ (function () {
        ...
        PrivateLinkResources.prototype.listByBotResource = function (resourceGroupName, resourceName, options, callback) {
            return this.client.sendOperationRequest({
                resourceGroupName: resourceGroupName,
                resourceName: resourceName,
                options: options
            }, listByBotResourceOperationSpec, callback);
        };
        return PrivateLinkResources;
    }());
    // Operation Specifications
    var serializer$8 = new msRest.Serializer(Mappers$8);
    var listByBotResourceOperationSpec = {
        httpMethod: "GET",
    ...
    var AzureBotServiceContext = /** @class */ (function (_super) {
        ...
        function AzureBotServiceContext(credentials, subscriptionId, options) {
            ...
            _this.apiVersion = '2021-05-01-preview';
    ...
    var AzureBotService = /** @class */ (function (_super) {
        ...
        function AzureBotService(credentials, subscriptionId, options) {
            ...
            _this.directLine = new DirectLine(_this);
            _this.operations = new Operations(_this);
            _this.botConnection = new BotConnection(_this);
            _this.hostSettings = new HostSettings(_this);
    ...
    exports.HostSettings = HostSettings;
