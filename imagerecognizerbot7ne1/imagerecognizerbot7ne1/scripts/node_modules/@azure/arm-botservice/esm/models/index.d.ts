 ...
 * @enum {string}
 */
export declare type MsaAppType = 'UserAssignedMSI' | 'SingleTenant' | 'MultiTenant';
/**
 ...
 */
export declare type OperationResultsBeginGetResponse = OperationResultsDescription & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
